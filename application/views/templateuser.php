        ...
        <div class="row flexslider-row">
          <div class="columns large-12">
            <div class="flexslider">
              <ul class="slides">
                <li> <img src="<?=base_url();?>assets/images/2.jpg" alt=""> </li>
                <li> <img src="<?=base_url();?>assets/images/1.jpeg" alt=""> </li>
				<li> <img src="<?=base_url();?>assets/images/5.jpeg" alt=""> </li>
              </ul>
            </div>
          </div>
        </div>
...
<div class="tagline">
  <div class="row">
    <div class="columns large-12">
      <div class="center">
        <h1>SELAMAT DATANG DI OBJEK WISATA DESA TAJUN</h1>
        <p> Tajun adalah sebuah desa yang terletak di kecamatan Kubutambahan, Kabupaten Buleleng, Provinsi Bali, Indonesia. Desa ini memiliki rata-rata ketinggian 550 meter dari permukaan laut.
		Desa Tajun akan mengemkembangkan wista dengan desa wisata berbasis spiritual karena banyak terdapat pura bersejarah dan tempatnya yang ada lembah dan bukit yang masih asri </p>
      </div>
    </div>
  </div>
</div>
<div class="service-box">
  <div class="row service">
    <div class="columns large-4">
      <h1 class="service-subtitle">PURA BUKIT SINUNGGAL</h1>
      <p><img src="<?=base_url();?>assets/images/3.jpg" alt="" class="threeUp"></p>
      <p> Pura Bukit Sinunggal yang terletak di Desa Tajun Kecamatan Kubutambahan Kabupaten Buleleng merupakan salah satu Pura Dang Kahyangan yang ada di Bali Utara.  </p>
      <p> <a href="<?=site_url('User/purabukitsinunggal');?>" class="button custom">details</a> </p>
    </div>
    <div class="columns large-4">
      <h1 class="service-subtitle">BHUWANA SIWA BUDHA</h1>
      <p><img src="<?=base_url();?>assets/images/8.jpeg" alt="" class="threeUp"></p>
      <p>Sejatinya Siwa-Budha juga disebutkan merupakan cerminan karakter dalam diri manusia, yaitu feminim dan maskulin.Selain itu,  juga dipahami sebagai evolusi sinkritisme antara dua ajaran besar yang pernah berkembang di Nusantara. Siwa-Budha bukan agama Barat atau agama Timur, melainkan agama tengah yang melebur bersama tradisi agama Hindu di Bali. </p>
      <p> <a href="<?=site_url('User/bhuawanasiwabudha');?>" class="button custom">details</a> </p>
    </div>
    <div class="columns large-4">
      <h1 class="service-subtitle">PURA GOA RAJA</h1>
      <p><img src="<?=base_url();?>assets/images/4.jpg" alt="" class="threeUp"></p>
      <p> Pura Goa Raja Tajun berada di Desa Tajun, Kubutambahan, Buleleng. Pura ini ada kaitannya dengan kisah Naga Gombang yang dihukum karena tak bisa menlan Puncak Bukit Sinunggal. </p>
      <p> <a href="<?=site_url('User/puragoaraja');?>" class="button custom">details</a> </p>
    </div>
  </div>
</div>
